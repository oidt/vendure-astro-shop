...
export type ListTopLevelCollectionsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type ListTopLevelCollectionsQuery = {
  __typename?: "Query";
  collections: {
    __typename?: "CollectionList";
    items: Array<{
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    getActiveChannel(
      ...
      options?: C,
    ): Promise<GetActiveChannelQuery> {
      return requester<GetActiveChannelQuery, GetActiveChannelQueryVariables>(
        GetActiveChannelDocument,
        variables,
        options,
      ) as Promise<GetActiveChannelQuery>;
    },
    listTopLevelCollections(
      variables?: ListTopLevelCollectionsQueryVariables,
      options?: C,
    ): Promise<ListTopLevelCollectionsQuery> {
      return requester<
        ListTopLevelCollectionsQuery,
        ListTopLevelCollectionsQueryVariables
      >(
        ListTopLevelCollectionsDocument,
        variables,
        options,
      ) as Promise<ListTopLevelCollectionsQuery>;
    },
    listCollections(
    ...
    getActiveOrder(
      ...
      options?: C,
    ): Promise<GetActiveOrderQuery> {
      return requester<GetActiveOrderQuery, GetActiveOrderQueryVariables>(
        GetActiveOrderDocument,
        variables,
        options,
      ) as Promise<GetActiveOrderQuery>;
    },
    addItemToOrder(
    ...
    removeItemFromOrder(
      variables: RemoveItemFromOrderMutationVariables,
      options?: C,
    ): Promise<RemoveItemFromOrderMutation> {
      return requester<
      ...
      >(
        ...
        variables,
        options,
      ) as Promise<RemoveItemFromOrderMutation>;
    },
    adjustOrderLine(
    ...
    getShippingMethods(
      ...
      >(
        ...
        variables,
        options,
      ) as Promise<GetShippingMethodsQuery>;
    },
    setShippingMethod(
      variables: SetShippingMethodMutationVariables,
      options?: C,
    ): Promise<SetShippingMethodMutation> {
      return requester<
      ...
      >(
        ...
        variables,
        options,
      ) as Promise<SetShippingMethodMutation>;
    },
    getPaymentMethods(
      variables?: GetPaymentMethodsQueryVariables,
      options?: C,
    ): Promise<GetPaymentMethodsQuery> {
      return requester<GetPaymentMethodsQuery, GetPaymentMethodsQueryVariables>(
        GetPaymentMethodsDocument,
        variables,
        options,
      ) as Promise<GetPaymentMethodsQuery>;
    },
    transitionToState(
      variables: TransitionToStateMutationVariables,
      options?: C,
    ): Promise<TransitionToStateMutation> {
      return requester<
      ...
      >(
        ...
        variables,
        options,
      ) as Promise<TransitionToStateMutation>;
    },
    addPaymentToOrder(
    ...
    getOrderByCode(
      variables: GetOrderByCodeQueryVariables,
      options?: C,
    ): Promise<GetOrderByCodeQuery> {
      return requester<GetOrderByCodeQuery, GetOrderByCodeQueryVariables>(
        GetOrderByCodeDocument,
        variables,
        options,
      ) as Promise<GetOrderByCodeQuery>;
    },
    getProductById(
      variables: GetProductByIdQueryVariables,
      options?: C,
    ): Promise<GetProductByIdQuery> {
      return requester<GetProductByIdQuery, GetProductByIdQueryVariables>(
        GetProductByIdDocument,
        variables,
        options,
      ) as Promise<GetProductByIdQuery>;
    },
    getProductBySlug(
      variables: GetProductBySlugQueryVariables,
      options?: C,
    ): Promise<GetProductBySlugQuery> {
      return requester<GetProductBySlugQuery, GetProductBySlugQueryVariables>(
        GetProductBySlugDocument,
        variables,
        options,
      ) as Promise<GetProductBySlugQuery>;
    },
